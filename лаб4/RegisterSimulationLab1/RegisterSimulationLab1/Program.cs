...
namespace RegisterSimulationLab1
{
    ...
    class Program
    {
        ...
        {
            Console.WriteLine(VerySimplePassGenerator.TrytoPredictThis("YuriiAndroshchuk", 20));
        ...
        public static async Task SavetoJson()
        {
            ...
            {
                fs.SetLength(0);
                User u = new User { Login = "Admin", Password = "Admin", Type ="Admin" };
    ...
    public class System 
    {
        ...
        {
            Console.Clear();
            Console.WriteLine("Student : Anroshchuk Yurii");
            Console.WriteLine("Group : IS -71");
            Console.WriteLine("Variant 2: Наявність букв і знаків арифметичних операцій.");
            Console.ReadLine();
            Console.Clear();
            Menu();
        }
